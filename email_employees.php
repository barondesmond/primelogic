...
'>Enroll Phone</A><BR> Pin # 728448<BR>\r\n";
$html .= "IOS App Primelogic Timeclock is available via Miradore Online.  Please enroll your phone at miradore online so we can deploy the Primelogic TimeClock app to your phone  .  Your email account that is registered on your phone needs to be your Email listed above or we need your email on your phone. If your email is different on your phone than above please let me know what the email is.  After logging in it will ask to download a certificate which you need to instal in General->Settings and then trust.  Then we can deploy the app to your phone which you will also have to accept to install timeclock app. <BR>\r\n";
