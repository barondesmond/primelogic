...
//$pdf->writeHTML($html, true, false, true, false, '');
	...
	$pdf -> writeHTMLCell('200', '20', '5', '10', $html, 1);
	$html = dispatch_priority($dbs);

	$pdf -> writeHTMLCell('200', '20', '5', '20', $html, $border);
	...
	$pdf -> writeHTMLCell('200', '20', '5', '120', $html, $border);
