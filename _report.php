...
function finchg($CustNo, $day)
{
	...
	$day1 = $day * -1;
	$day2 = $day1 - 30;
	$sql = "SELECT Invoice, Dept, '' as Terms, CONVERT(varchar(10), Sales.InvDate, 101) as InvDates, CONVERT(decimal(10,2), Receivab.Paid) as Paids, CONVERT(decimal(10,2), InvAmt) as InvAmts FROM Receivab WHERE CustNo=" . $CustNo . " and Type = 'F'
